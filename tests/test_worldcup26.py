...
def test_kickoff_and_date_naive_when_no_zone():
    ko, date = wc._kickoff_and_date("06/11/2026 13:00", None)
    assert ko == "2026-06-11T13:00:00"
    assert date == "2026-06-11"


def test_kickoff_localised_to_utc_from_venue_zone():
    # 18:00 in Houston (CDT = UTC-5 in June) -> 23:00 UTC; venue date unchanged
    ko, date = wc._kickoff_and_date("06/12/2026 18:00", "America/Chicago")
    assert ko == "2026-06-12T23:00:00+00:00"
...
def test_get_dataset_maps_games(monkeypatch):
    canned = {
        "/get/games": {"games": [
            {"id": "1", "type": "group", "group": "D", "finished": "TRUE",
             "local_date": "06/12/2026 18:00", "matchday": "1", "stadium_id": "5",
            ...
            {"id": "2", "type": "group", "group": "D", "finished": "FALSE",
             "local_date": "06/18/2026 18:00", "matchday": "2", "stadium_id": "5",
            ...
            {"id": "73", "type": "r32", "group": "R32", "finished": "FALSE",
             "local_date": "06/28/2026 12:00", "matchday": None, "stadium_id": "5",
             "home_team_name_en": None, "away_team_name_en": None,
             "home_score": "0", "away_score": "0",
             "home_scorers": "null", "away_scorers": "null"},
        ]},
        "/get/stadiums": {"stadiums": [{"id": "5", "city_en": "Houston"}]},
    }
    monkeypatch.setattr(wc, "_get", lambda path: canned[path])
    ...
    # 18:00 Houston (CDT) -> 23:00 UTC
    assert played["kickoff"] == "2026-06-12T23:00:00+00:00"
